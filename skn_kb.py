...
def input_rules():
    global kb,q
    kb=(input("Enter rule (in terms of p and q) :"))    
...
ans=entailment()
if ans:
    print("The Knowlege Base entails query ")
else:
    print("The Knowlege Base does not entail query ")

'''
OUTPUT :

Enter rule (in terms of p and q) :(~p^~q)v(p^q)
Enter the Query : pvq
